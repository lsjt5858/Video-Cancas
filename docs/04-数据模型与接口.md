...
CREATE TABLE shots (
  ...
  duration FLOAT NOT NULL DEFAULT 4,
  description TEXT,
  characters JSONB,
  location VARCHAR(255),
  action TEXT,
  shot_size VARCHAR(100),
...
PATCH  /api/canvas/nodes/{node_id}
DELETE /api/canvas/nodes/{node_id}
POST   /api/projects/{project_id}/canvas/edges
DELETE /api/canvas/edges/{edge_id}
PUT    /api/projects/{project_id}/canvas/layout
```
